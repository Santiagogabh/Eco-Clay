        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Millones de personas sufren las consecuencias de la polución diaria
            </p>
          </div>
      ...
      <div className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Herramientas poderosas para generar un impacto real
            </p>
          </div>
      ...
      <div className="bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-white/80 text-sm mt-4">
            ✓ Sin costos ✓ Sin anuncios ✓ Impacto real
          </p>
        </div>
      </div>
