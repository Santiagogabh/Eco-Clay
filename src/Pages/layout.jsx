...
export default function MapaLimpioLayout() {
  ...
  const navigationItems = [
    { title: "Mapa", icon: MapPin, gradient: "from-emerald-400 to-teal-500", shadowColor: "shadow-emerald-500/40" },
    { title: "Eventos", icon: Calendar, gradient: "from-blue-400 to-cyan-500", shadowColor: "shadow-blue-500/40" },
    { title: "Perfil", icon: User, gradient: "from-purple-400 to-pink-500", shadowColor: "shadow-purple-500/40" },
    { title: "Donaciones", icon: Heart, gradient: "from-rose-400 to-orange-500", shadowColor: "shadow-rose-500/40" },
  ];
